...
async def run_coding_task(
    ...
    async with semaphore:
        ...
        idea = (
            task["question"]
            + f"I wish you finish the task with a multi-agent cooperation ,The context information is provided in a file named `context.txt` in your workspace.\n"
